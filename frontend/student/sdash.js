...
import { grades, reports } from "../fakeDB.js";

const email = localStorage.getItem("user_email");

// Grades
const gradeTable = document.getElementById("gradesBody");
gradeTable.innerHTML = "";

grades
  .filter(g => g.studentEmail === email)
  .forEach(g => {
    gradeTable.innerHTML += `
      <tr>
        <td>${g.subject}</td>
...
// Reports
const reportTable = document.getElementById("studentReports");
if (reportTable) {
...
if (role !== "student") window.location.href = "../Login/login.html";
...
import { reports, grades } from "../fakeDB.js";

// Reports
const reportTable = document.getElementById("parentReports");
...
// Grades
const gradeTable = document.getElementById("parentGrades");
...
if (role !== "parent") window.location.href = "../Login/login.html";